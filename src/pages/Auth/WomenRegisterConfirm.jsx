      ...
      >
        ...
        <Box className="women_input_group">
          ...
          <div style={{ paddingRight: '10px', paddingLeft: '10px' }}>
            <RouterLink to="/women_register" style={{ marginRight: '15px' }}>
              <Button
                ...
                style={{
                  width: '35%',
                  backgroundImage:
                    'linear-gradient(to right, #C9BFCB, #C9BFCB)',
                }}
              >
                戻る
              </Button>
            </RouterLink>
            <RouterLink to="/register_verify_option">
              <Button
                className="women-register-btn"
                variant="contained"
                style={{ width: '55%' }}
...
export default WomenRegisterConfirm;
